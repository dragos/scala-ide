...
/** A `Symbol` or `Tree` modifier, such as `private` or `lazy`.
 * 
 *  @note This is copied from Scala 2.10 `scala.reflect.api.Modifier` and should
 *        be replaced by the corresponding type once we drop support for Scala 2.9
 */
